"""
plot_pipeline_vs_rov_profile_v7.py
------------------------------------
...
produced by `rov_pipeline_rl_v7.py --evaluate`), and reports the tracking
error (RMSE, mean, max).
...
Usage:
    python plot_pipeline_vs_rov_profile_v7.py
    python plot_pipeline_vs_rov_profile_v7.py --csv evaluation/eval_trajectory.csv
"""
...
from rov_pipeline_rl_v7 import SCENE
