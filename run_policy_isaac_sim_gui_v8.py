"""
run_policy_isaac_sim_gui_v8.py
--------------------------------
Watch the trained PPO policy (rov_pipeline_policy_v8.pt) fly the ROV along
...
(line_tracking_controller.py's BLUEROV_GUI switch):
    ...
    cd /home/mcschin1/Downloads/nvidia_rov/rov_pipeline_v8
    python run_policy_isaac_sim_gui_v8.py            # opens the Isaac Sim window
    HEADLESS=1 python run_policy_isaac_sim_gui_v8.py  # no window, just logs

The policy was trained at a fixed dt=0.05s (20 Hz) RK4 step (see
rov_pipeline_rl_v8.py); Isaac Sim's PhysicsScene here runs at the default
...
PHYSICS_HZ = 60.0
POLICY_DT = 0.05  # must match rov_pipeline_rl_v8.py's FossenROVDynamics dt
...
def main():
    ...
    from rov_pipeline_rl_v8 import (
